  ...
  describe('#constructor()', () => {
    ...
    describe('hooks', () => {
      ...
      afterEach(() => {
        ...
        prepareDeploymentStub.restore();
        createDeploymentStub.restore();
        generateArtifactDirectoryNameStub.restore();
        compileFunctionsStub.restore();
        uploadArtifactsStub.restore();
        updateDeploymentStub.restore();
        cleanupDeploymentBucketStub.restore();
      });
